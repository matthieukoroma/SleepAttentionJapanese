function [beep,samplingRate] = MakeBeepAP(freq,duration,samplingRate)
% [beep,samplingRate] = MakeBeepAP(freq,duration,[samplingRate])
%
...
beep = cos(2*pi*freq*(0:(duration*samplingRate))/samplingRate);
